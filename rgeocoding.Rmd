...
- datum: specifies the shape of the earth (the Ellipsoid) and how the coordinate system is anchored to the shape.
- units: e.g., meters, feet, decimal degrees
- origin: X-axis = Prime Meridian, Y-axis = Equator
...
These global CRSs area identical for most purposes.
